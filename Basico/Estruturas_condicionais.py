...
'''
Else
Em alguns casos, queremos que o programa escolha entre 2 casos mutuamente exclusivos. 
Para isso utilizamos o else. O else não possui condição para verificar. 
...
O comando elif é a contração de "else if" - ou seja, caso um if não seja executado, 
